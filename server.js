...
app.get('/', (req, res) => {
    res.send(`
        <h1>🚀 Klaunx AI License Server</h1>
        <p>Server is running successfully!</p>
        <h3>📊 Admin Dashboard</h3>
        <p>Set ADMIN_KEY environment variable and visit <a href="/admin">/admin</a></p>
        <h3>🔗 API Endpoints:</h3>
        <ul>
            <li>POST /api/validate-license - Validate license keys</li>
            <li>POST /api/auth/token - Get JWT tokens</li>
            <li>POST /api/v1/analyze - AI analysis proxy</li>
            <li>GET /api/usage/:license_key - Usage stats</li>
            <li>GET /api/admin/usage - Admin dashboard data</li>
        </ul>
        <style>
...
<head>
    ...
    <style>
        body { font-family: -apple-system, BlinkMacSystemFont, sans-serif; background: linear-gradient(135deg, #667eea, #764ba2); min-height: 100vh; margin: 0; padding: 20px; }
        .container { max-width: 800px; margin: 0 auto; }
        .card { background: white; border-radius: 10px; padding: 30px; margin: 20px 0; box-shadow: 0 10px 30px rgba(0,0,0,0.1); }
        .header { text-align: center; color: white; margin-bottom: 30px; }
        .header h1 { font-size: 2.5em; margin-bottom: 10px; }
        input { width: 100%; padding: 15px; border: 1px solid #ddd; border-radius: 5px; margin: 10px 0; font-size: 16px; }
        button { background: #007AFF; color: white; border: none; padding: 15px 30px; border-radius: 5px; cursor: pointer; font-size: 16px; }
        ...
        .license-badge { padding: 4px 8px; border-radius: 4px; font-size: 0.8em; font-weight: bold; }
        .lifetime { background: #d4edda; color: #155724; }
        .yearly { background: #fff3cd; color: #856404; }
        .monthly { background: #d1ecf1; color: #0c5460; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Monitor user activity and manage licenses</p>
        </div>
    ...
    <script>
        ...
        function updateDashboard(data) {
            ...
            licenses.forEach(license => {
                ...
                row.innerHTML = \`
                    <td><code>\${license.key.substring(0, 25)}...</code></td>
